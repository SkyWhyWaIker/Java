...
import org.lab.Specification.PetSpecifications;
...
public class PetServiceImpl implements PetService {
    ...
    @Override
    public Page<PetDTO> getPetsWithFilters(String color, String type, String name, Pageable pageable) {
        Specification<Pet> spec = PetSpecifications.withFilters(color, type, name);
